...
第二身份需要**两重身份**组合认证，常见的有效组合如下图：

![第二身份激活简介](/second-identity-activation.png)
...
::: warning 社团 ≠ 校级组织
很多人问「我加了社团，为什么还没激活第二身份」——**社团只是社团，不能当作校级组织**。只加入一个社团（或任何单一身份）无法激活第二身份，必须凑齐上图中的任意一种**组合**。加入组织前先问清楚它属于哪一类：校级组织、院级组织、社团还是班委，别等到认证时才发现自己的两个身份是同一类。
:::
