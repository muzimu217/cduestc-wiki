        ...
        '/': [
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: '入党流程', link: '/campus/party' },
                    { text: '资助政策', link: '/campus/aid' },
                    { text: '征兵入伍', link: '/campus/enlist' },
                ...
                items: [
                    { text: '校历/作息时间表', link: '/study/schedule' },
                    {
                        ...
                        items: [
                            ...
                            { text: '考研', link: '/study/postgrad' },
                        ],
                    },
                    { text: '奖学金与荣誉评定', link: '/study/scholarship' },
