...
日常口语里，很多办卡摊位、推销把**校园卡**（运营商推出的校内流量套餐手机卡）简称为「校园网」。但**学校里正式讲的校园网**是另一个东西：学校在公共教学区域（教学楼、图书馆等）提供的校内网络，也就是下面用学号 + 密码认证的那个。两者没有必然联系：

- **校园网**：学校自己的网络，在教学区域连接后用学号认证使用，不需要办卡。
- **校园卡**：运营商手机卡（校内流量套餐），主要解决手机流量与宿舍宽带，办不办都不影响连接校园网。
- **宿舍宽带**：宿舍区域上网需另办运营商有线/无线宽带，见[入学页「校园网与宽带」](/campus/entrance#校园网与宽带)。

营销话术识别与防骗详见[新生防骗指南「校园网/校园卡相关」](/campus/anti-fraud#network-card)。
