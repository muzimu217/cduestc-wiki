...
特别注意：办卡推销常把校园卡（校内流量套餐）**简称为「校园网」**，而学校里正式讲的校园网指的是公共教学区域、用学号认证的学校自有网络，两者不是一回事，详见[职能部门页「校园网」](/campus/connect#校园网)。

#### 校园网与校园卡的关系

是否办理校园卡与能否使用校园网**没有必然联系**。教学区域的校园网由学校建设运维，凭学号认证即可使用；未办理校园卡时，同学们可以用手机流量上网，也可以在教学区域连接校园网；办理了校园卡后，则可以通过宿舍 WIFI 或宽带上网。
...
错误！选课期间同学们需要通过学校**数字校园统一身份认证**进入教务系统选课，任何一台连接了网络的设备均可以登录教务系统，与是否办理校园卡没有关系。

#### 宿舍内无法装宽带？

错误！我校宿舍接入了电信、移动、联通等运营商的有线宽带，办理了校园卡后即可使用宽带上网。
